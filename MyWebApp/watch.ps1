$project = "C:\Users\WELCOME\Documents\Java Class\MyWebApp"
...
$tomcatApp = "$tomcat\webapps\MyWebApp"
...
Write-Host "Application: http://localhost:8080/MyWebApp/"
Write-Host ""
    ...
    foreach ($file in $files) {
        ...
        if ($lastWrite[$file.FullName] -ne $time) {
            ...
            if ($LASTEXITCODE -eq 0) {
                ...
                Write-Host "Open: http://localhost:8080/MyWebApp/"
            }
            else {
